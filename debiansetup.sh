...
sudo apt install \
    ...
    git vim neovim flameshot zsh zsh-sytax-highlighting
...
# setup gitconfig
curl -sO "https://github.com/lf32/DOT/raw/main/git/.gitconfig"
curl -sO "https://github.com/lf32/DOT/raw/main/git/.gittemplate"
